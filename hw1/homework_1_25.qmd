...
for ticker in stock_price['ticker'].unique():
    ticker_data = stock_price[stock_price['ticker'] == ticker]
...
page.goto('https://www.cagematch.net/?id=2&view=statistics')

link = 'https://www.cagematch.net/?id=2&view=statistics'
top_wrestlers = requests.get(link)
wrestlers_soup = BeautifulSoup(top_wrestlers.content, 'html.parser')
top_wrestlers = wrestlers_soup.select(
  '.TRow1, .TRow2'
)
```
