...
Stemming is a brute force method that hacks the end off of a word. In this cell, it "commonizes" the word love.
...
Taking something to a tfidf matrix will show you where you lacked in your text cleaning.
```{python}
